 ...
 */
class getLoyaltyCardRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LoyaltyCardRepository' shared autowired service.
     *
     * @return \App\Repository\LoyaltyCardRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LoyaltyCardRepository.php';

        return $container->privates['App\\Repository\\LoyaltyCardRepository'] = new \App\Repository\LoyaltyCardRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
