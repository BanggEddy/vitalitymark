 ...
 */
class getProductsControllerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProductsControllerRepository' shared autowired service.
     *
     * @return \App\Repository\ProductsControllerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductsControllerRepository.php';

        return $container->privates['App\\Repository\\ProductsControllerRepository'] = new \App\Repository\ProductsControllerRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
