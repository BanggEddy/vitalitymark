...
class __TwigTemplate_30d0cea1500b7608d0ecf63451ce638b extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("promo", $context)) {
        ...
        // line 78
        echo "            <a href=\"/uservue\" class=\"btn btn-details\">< Retour</a>
        </div>
    </div>
...
{% block body %}
    ...
    <div class=\"container nature\">
        <div class=\"row\">
            ...
            {% endif %}
            <a href=\"/uservue\" class=\"btn btn-details\">< Retour</a>
        </div>
    </div>
...
{% endblock %}
", "user/uservue/details.html.twig", "C:\\Users\\David\\Desktop\\vitalitymark\\templates\\user\\uservue\\details.html.twig");
    }
}
